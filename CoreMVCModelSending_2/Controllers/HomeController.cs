...
namespace CoreMVCModelSending_2.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            //Eger bir View metodu bir string argüman ile cagrılıyorsa artık icinde cagrıldıgı Action isminde bir View sayfası aramaz sizin ona verdiginiz string argüman isminde bir View sayfası arar...Ancak bilmelisniz bir View'in bu şekilde kullanılması standart degildir...Cünkü biz View'ların Action isimleriyle denk düsmesini isteriz ki Projemiz icerisinde barındırılan kodlar temiz bir şekilde gözüksün...
